...
public class addResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(133, 245, 245));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String rolln = jTextField1.getText();
        ...
        String os = jTextField6.getText();
         try{
             ...
             ResultSet rst = st.executeQuery("select * from student where rollno ='"+rolln+"' ");
             if(rst.next()){
                 int updated = st.executeUpdate("INSERT INTO result(rollno,physics,maths,em,dbms,os) VALUES('"+rolln+"','"+physics+"','"+maths+"','"+em+"','"+dbms+"','"+os+"')");
               //  st.executeUpdate("INSERT INTO result(rollno,physics,maths,em,dbms,os) VALUES('"+rolln+"','"+physics+"','"+maths+"','"+em+"','"+dbms+"','"+os+"')");
               if(updated>0){
